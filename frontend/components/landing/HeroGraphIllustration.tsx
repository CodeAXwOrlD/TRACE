...
export function HeroGraphIllustration() {
  ...
  return (
    <div className="stage anim" style={{ ["--d" as any]: ".4s" }} ref={stageRef}>
      <div className="float">
      ...
      <div className="fcard risk">
        <div className="cl">SAME TRANSACTION, TWO NUMBERS</div>
        <div className="mrow">
      ...
      <div className="fcard agent">
        <div className="ahead">
          <span className="adot" />
          AGENT INVESTIGATING CASE-0007
        </div>
        <AgentStepsPreview />
      </div>
    </div>
